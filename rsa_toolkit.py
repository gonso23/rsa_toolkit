#!/usr/bin/env python3
"""
RSA Encryption Toolkit - Simple asymmetric encryption
...
def main():
    parser = argparse.ArgumentParser(description="RSA Encryption Toolkit")
    parser.add_argument('key_name', nargs='?', help='Key name (used by all encrypt/decrypt commands)')
...
def print_help(key_name=None):
    """Print usage help"""
    print("# RSA Encryption Toolkit")
    print()
    print("# Security")
    print("Used algorithms: RSA-OAEP-SHA256 + AES-256-CBC")
    print("Security: 2048-bit RSA (current standard), 256-bit AES")
    print()
    if key_name:
        print(f"# Using key: {key_name}")
        print()
    print("# Generate keys")
    print('python rsa_toolkit.py --generate-keys myKey')
    print('python rsa_toolkit.py -k 4096 -gk mySecKey')
    print()
    print("# Short text (RSA only, max ~190 bytes)")
    print("## Encrypt")
    print(f'python rsa_toolkit.py {key_name or "myKey"} -et "Secret message"')
    print("## Decrypt") 
    print(f'python rsa_toolkit.py {key_name or "myKey"} -dt "BASE64_STRING"')
    print()
    print("# Long text (AES+RSA hybrid, unlimited size, SAME FORMAT!)")
    print("## Encrypt")
    print(f'python rsa_toolkit.py {key_name or "myKey"} -el "Very long message..."')
    print("## Decrypt")
    print(f'python rsa_toolkit.py {key_name or "myKey"} -dl "BASE64_HYBRID_STRING"')
    print()
    print("# Files (hybrid AES+RSA)")
    print("## Encrypt")
    print(f'python rsa_toolkit.py {key_name or "myKey"} -ef budget.xlsx')
    print("## Decrypt")
    print(f'python rsa_toolkit.py {key_name or "myKey"} -df budget.xlsx.encrypted')
